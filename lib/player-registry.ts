...
export const PLAYER_REGISTRY: PlayerRegistryEntry[] = [
  ...
  { name: 'Xavi Simons',               nationality: 'Netherlands', category: 'group-f',                      apiFootballId: 162016, nationalTeamId: 1118 },
  ...
  { name: 'Takumi Minamino',           nationality: 'Japan',       category: 'group-f',                      apiFootballId: 1101,   nationalTeamId: 12 },
